...
const topSituations = [
  ...
  { label: "Squatter-Occupied House", href: "/sell-house-with-squatters-fresno", desc: "Unauthorized occupants, vandalism, or limited access" },
  { label: "Probate Sales", href: "/probate-homes", desc: "Complete guide to selling inherited properties" },
...
const footerCompany = [
  ...
  { label: "Alder vs Fair Trade", href: "/alder-vs-fair-trade-real-estate" },
    ...
    <div className="min-h-screen flex flex-col" style={{ background: "oklch(0.97 0.015 85)" }}>
      ...
      <div style={{ background: "oklch(0.55 0.13 42)", color: "white" }} className="py-2 text-center">
        <div className="flex items-center justify-center gap-2 flex-wrap px-4">
          ...
          <a href={phone.href} onClick={trackPhoneClick} style={{ fontFamily: "'DM Mono', monospace", fontSize: "0.75rem", fontWeight: 700, letterSpacing: "0.05em", textDecoration: "underline", color: "white", opacity: 0.9 }}>
            Call: {phone.label}
          </a>
        </div>
      </div>
        ...
        <div className="container">
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <div className="flex lg:hidden items-center gap-3">
              <a href={phone.href} onClick={trackPhoneClick} aria-label="Call Alder Heritage Homes at (559) 281-8016" style={{ color: "oklch(0.28 0.05 155)" }}>
                <Phone size={20} />
              </a>
          ...
          <div className="lg:hidden border-t overflow-y-auto" style={{ background: "white", borderColor: "oklch(0.88 0.02 85)", maxHeight: "80vh" }}>
            <div className="py-2">
              ...
              <div className="px-4 pt-3 pb-6">
                ...
                <a href={phone.href} onClick={trackPhoneClick} className="flex items-center justify-center gap-2 py-3 rounded-xl font-bold border-2" style={{ fontFamily: "'DM Mono', monospace", color: "oklch(0.28 0.05 155)", borderColor: "oklch(0.28 0.05 155)" }}>
        ...
        <div className="container py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div>
              ...
              <a href={phone.href} onClick={trackPhoneClick} className="flex items-center gap-2 font-bold mb-2" style={{ fontFamily: "'DM Mono', monospace", color: "oklch(0.55 0.13 42)", fontSize: "0.95rem" }}>
                <Phone size={15} /> {phone.label}
              </a>
          ...
          <div className="mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4" style={{ borderTop: "1px solid oklch(0.30 0.01 60)" }}>
            <p className="text-xs" style={{ color: "oklch(0.45 0.01 60)" }}>
              ...
              <a href="/cash-home-buyer-site-map" style={{ color: "oklch(0.55 0.01 60)", textDecoration: "underline" }}>Site Map</a>
            </p>
