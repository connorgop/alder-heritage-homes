...
const keywords: Keyword[] = [
  ...
  { keyword: "tired landlord sell rental property Fresno", intent: "transactional", difficulty: "Low", volume: "45/mo", why: "Landlords with problem tenants or deferred maintenance. Want out with no repairs.", hasPage: true, url: "/sell-house-with-tenants-fresno" },
  ...
  { keyword: "how to sell a rental property with tenants", intent: "informational", difficulty: "Low", volume: "110/mo", why: "Tired landlords researching options. Tired Landlord page target.", hasPage: true, url: "/sell-house-with-tenants-fresno" },
