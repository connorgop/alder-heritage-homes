...
export default function ForeclosureHelp() {
  ...
  return (
    <ServicePage
      ...
      subtitle="If your lender has started the foreclosure process, you still have options. We can close in as little as 3 days and help you walk away with cash instead of a foreclosure on your record."
      heroImage={IMG}
