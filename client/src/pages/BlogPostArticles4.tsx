...
const articleChunk4: Record<string, React.ReactNode> = {
  ...
  "sell-my-house-sunnyside-fresno": (
    <div>
      ...
      <p>Alder Heritage Homes is different. Connor Alder is a licensed California real estate agent (DRE #02219124) who actually purchases your home with his own capital. There is no middleman, no contract assignment, and no hidden fees. You deal with Connor from the first phone call through closing day.</p>
