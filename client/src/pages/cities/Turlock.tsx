/* Turlock City Landing Page — Alder Heritage Homes */
...
const faqs = [
  { q: "Do you actually buy homes in Turlock, CA?", a: "Yes. Connor Morris is the actual buyer — a licensed California real estate agent (DRE #02219124) who purchases with his own capital. Not a wholesaler, not a middleman. His name is on every contract and he closes what he opens." },
  { q: "How fast can you close on a Turlock home?", a: "We can typically close in 5–14 days once we have a signed contract and clear title. We have closed in as few as 5 days for sellers facing imminent foreclosure." },
  { q: "Do you buy distressed or run-down homes in Turlock?", a: "Yes. We specialize in distressed properties — fire damage, water damage, foundation issues, code violations, hoarder homes, and properties in any condition. We buy as-is and handle all cleanup." },
  { q: "Can you help if I am behind on mortgage payments in Turlock?", a: "Absolutely. We specialize in pre-foreclosure situations. We can often close before the foreclosure sale date, pay off your mortgage, and put cash in your pocket — helping you avoid the credit damage of a foreclosure." },
  { q: "What neighborhoods in Turlock do you buy in?", a: "We buy throughout Turlock — Brookside, Lincoln Village, Spanos Park, Weston Ranch, South Turlock, North Turlock, the Waterfront District, and surrounding Stanislaus County communities including Lodi, Tracy, Manteca, and Ripon." },
...
const neighborhoods = ["Brookside", "Lincoln Village", "Spanos Park", "Weston Ranch", "South Turlock", "North Turlock", "Waterfront District", "Morada", "Lodi", "Tracy", "Manteca", "Ripon"];
export default function Turlock() {
  useSEO({
    title: "We Buy Houses in Turlock CA — Cash Offers in 24 Hours",
    description: "Alder Heritage Homes buys houses in Turlock and Stanislaus County for cash. Licensed CA Agent (DRE #02219124). No wholesaling. Free Broker Opinion of Value. Close in 5–14 days. No repairs, no commissions.",
    canonical: "/we-buy-houses-turlock",
  });
  return (
    <Layout>
      <SchemaMarkup schema={faqSchema(faqs)} id="faq-turlock" />
      <section className="relative py-24 overflow-hidden" style={{ background: "oklch(0.22 0.01 60)" }}>
        <div className="absolute inset-0">
          <img src={HERO_IMG} alt="We buy houses in Turlock CA" className="w-full h-full object-cover opacity-20" />
        ...
        <div className="container relative z-10">
          <div className="max-w-2xl">
            <span className="inline-block px-3 py-1 rounded-full text-xs font-bold mb-4" style={{ background: "oklch(0.55 0.13 42)", color: "white", fontFamily: "'DM Mono', monospace", letterSpacing: "0.08em", textTransform: "uppercase" }}>We Buy Houses in Turlock, CA</span>
            <h1 className="text-3xl md:text-5xl font-bold text-white mb-4" style={{ fontFamily: "'Lora', serif", lineHeight: 1.2 }}>Sell Your Turlock Home for Cash — Fast, Fair, No Repairs</h1>
            <p className="text-lg mb-8 leading-relaxed" style={{ color: "oklch(0.80 0.01 60)", fontFamily: "'Nunito Sans', sans-serif" }}>Alder Heritage Homes buys houses throughout Turlock and Stanislaus County. Cash offer in 24 hours, close in 5–14 days. Licensed CA real estate agent — not a wholesaler.</p>
        ...
        <div className="container">
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              <h2 className="text-2xl md:text-3xl font-bold mb-6" style={{ fontFamily: "'Lora', serif", color: "oklch(0.22 0.01 60)" }}>Turlock's Honest Cash Home Buyer</h2>
              <p className="text-lg leading-relaxed mb-6" style={{ color: "oklch(0.35 0.01 60)", fontFamily: "'Nunito Sans', sans-serif" }}>Turlock is the largest city in Stanislaus County — a port city with deep agricultural roots and a dynamic real estate market that has seen dramatic cycles. We buy homes throughout Turlock and Stanislaus County, from Brookside and Lincoln Village to South Turlock and the waterfront.</p>
              ...
              <p className="leading-relaxed mb-8" style={{ color: "oklch(0.40 0.01 60)", fontFamily: "'Nunito Sans', sans-serif" }}>Stanislaus County's median home price is approximately $380,000-$410,000 as of 2026, slightly above the Stanislaus County median due to its strong school district and CSU Stanislaus proximity. Every offer comes with a free Broker Opinion of Value showing you exactly how we arrived at our number.</p>
              <h3 className="text-xl font-bold mb-4" style={{ fontFamily: "'Lora', serif", color: "oklch(0.22 0.01 60)" }}>Situations We Handle in Turlock</h3>
