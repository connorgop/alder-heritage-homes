/* Stockton City Landing Page — Alder Heritage Homes */
...
const faqs = [
  { q: "Do you actually buy homes in Stockton, CA?", a: "Yes. Connor Morris is the actual buyer — a licensed California real estate agent (DRE #02219124) who purchases with his own capital. Not a wholesaler, not a middleman. His name is on every contract and he closes what he opens." },
  { q: "How fast can you close on a Stockton home?", a: "We can typically close in 5–14 days once we have a signed contract and clear title. We have closed in as few as 5 days for sellers facing imminent foreclosure." },
  { q: "Do you buy distressed or run-down homes in Stockton?", a: "Yes. We specialize in distressed properties — fire damage, water damage, foundation issues, code violations, hoarder homes, and properties in any condition. We buy as-is and handle all cleanup." },
  { q: "Can you help if I am behind on mortgage payments in Stockton?", a: "Absolutely. We specialize in pre-foreclosure situations. We can often close before the foreclosure sale date, pay off your mortgage, and put cash in your pocket — helping you avoid the credit damage of a foreclosure." },
  { q: "What neighborhoods in Stockton do you buy in?", a: "We buy throughout Stockton — Brookside, Lincoln Village, Spanos Park, Weston Ranch, South Stockton, North Stockton, the Waterfront District, and surrounding San Joaquin County communities including Lodi, Tracy, Manteca, and Ripon." },
...
export default function Stockton() {
  ...
  return (
    <Layout>
      <SchemaMarkup schema={faqSchema(faqs)} id="faq-stockton" />
      <section className="relative py-24 overflow-hidden" style={{ background: "oklch(0.22 0.01 60)" }}>
        <div className="absolute inset-0">
          <img src={HERO_IMG} alt="We buy houses in Stockton CA" className="w-full h-full object-cover opacity-20" />
        ...
        <div className="container relative z-10">
          <div className="max-w-2xl">
            <span className="inline-block px-3 py-1 rounded-full text-xs font-bold mb-4" style={{ background: "oklch(0.55 0.13 42)", color: "white", fontFamily: "'DM Mono', monospace", letterSpacing: "0.08em", textTransform: "uppercase" }}>We Buy Houses in Stockton, CA</span>
            <h1 className="text-3xl md:text-5xl font-bold text-white mb-4" style={{ fontFamily: "'Lora', serif", lineHeight: 1.2 }}>Sell Your Stockton Home for Cash — Fast, Fair, No Repairs</h1>
            <p className="text-lg mb-8 leading-relaxed" style={{ color: "oklch(0.80 0.01 60)", fontFamily: "'Nunito Sans', sans-serif" }}>Alder Heritage Homes buys houses throughout Stockton and San Joaquin County. Cash offer in 24 hours, close in 5–14 days. Licensed CA real estate agent — not a wholesaler.</p>
        ...
        <div className="container">
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              <h2 className="text-2xl md:text-3xl font-bold mb-6" style={{ fontFamily: "'Lora', serif", color: "oklch(0.22 0.01 60)" }}>Stockton's Honest Cash Home Buyer</h2>
              <p className="text-lg leading-relaxed mb-6" style={{ color: "oklch(0.35 0.01 60)", fontFamily: "'Nunito Sans', sans-serif" }}>Stockton is the largest city in San Joaquin County — a port city with deep agricultural roots and a dynamic real estate market that has seen dramatic cycles. We buy homes throughout Stockton and San Joaquin County, from Brookside and Lincoln Village to South Stockton and the waterfront.</p>
              ...
              <p className="leading-relaxed mb-8" style={{ color: "oklch(0.40 0.01 60)", fontFamily: "'Nunito Sans', sans-serif" }}>San Joaquin County's median home price is approximately $450,000 as of 2026, supported by Bay Area commuters and strong local demand. Every offer comes with a free Broker Opinion of Value showing you exactly how we arrived at our number.</p>
              <h3 className="text-xl font-bold mb-4" style={{ fontFamily: "'Lora', serif", color: "oklch(0.22 0.01 60)" }}>Situations We Handle in Stockton</h3>
            ...
            <div className="space-y-6">
              <div className="rounded-2xl overflow-hidden sticky top-24" style={{ background: "oklch(0.55 0.13 42)" }}>
                <div className="px-5 pt-5 pb-2">
                  <h3 className="font-bold text-lg mb-1" style={{ fontFamily: "'Lora', serif", color: "white" }}>Get Your Stockton Cash Offer</h3>
                ...
                <div className="px-4 pb-2">
                  <CashOfferForm city="Stockton" variant="dark" />
                </div>
      ...
      <section id="get-offer" className="py-20" style={{ background: "oklch(0.22 0.01 60)" }}>
        <div className="max-w-2xl mx-auto px-6">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-3" style={{ fontFamily: "'Lora', serif" }}>Ready to Sell Your Stockton Home?</h2>
            <p className="text-lg" style={{ color: "oklch(0.70 0.01 60)", fontFamily: "'Nunito Sans', sans-serif" }}>Fill out the form below and Connor will have a cash offer for your Stockton property within 24 hours. No repairs, no commissions, no pressure.</p>
          </div>
          <CashOfferForm city="Stockton" variant="dark" />
