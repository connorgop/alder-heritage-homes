...
const faqs = [
  { q: "Do you actually buy homes in Modesto, CA?", a: "Yes. Connor Morris is the actual buyer — a licensed California real estate agent (DRE #02219124) who purchases with his own capital. Not a wholesaler, not a middleman. His name is on every contract and he closes what he opens." },
...
export default function Modesto() {
  useSEO({
    title: "We Buy Houses in Modesto CA",
            ...
            <div className="space-y-6">
              <div className="rounded-2xl overflow-hidden sticky top-24" style={{ background: "oklch(0.55 0.13 42)" }}>
                <div className="px-5 pt-5 pb-2">
                  <h3 className="font-bold text-lg mb-1" style={{ fontFamily: "'Lora', serif", color: "white" }}>Get Your Modesto Cash Offer</h3>
                ...
                <div className="px-4 pb-2">
                  <CashOfferForm city="Modesto" variant="dark" />
                </div>
      ...
      <section id="get-offer" className="py-20" style={{ background: "oklch(0.22 0.01 60)" }}>
        <div className="max-w-2xl mx-auto px-6">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-3" style={{ fontFamily: "'Lora', serif" }}>Ready to Sell Your Modesto Home?</h2>
            <p className="text-lg" style={{ color: "oklch(0.70 0.01 60)", fontFamily: "'Nunito Sans', sans-serif" }}>Fill out the form below and Connor will have a cash offer for your Modesto property within 24 hours. No repairs, no commissions, no pressure.</p>
          </div>
          <CashOfferForm city="Modesto" variant="dark" />
