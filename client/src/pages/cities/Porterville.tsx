...
const faqs = [
  { q: "Do you actually buy homes in Porterville, CA?", a: "Yes. Connor Alder is the actual buyer — a licensed California real estate agent (DRE #02219124) who purchases with his own capital. Not a wholesaler, not a middleman. His name is on every contract and he closes what he opens." },
    ...
    <Layout>
      ...
      <section className="py-14" style={{ background: "oklch(0.22 0.01 60)" }}>
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-3" style={{ fontFamily: "'Lora', serif" }}>Ready to Talk About Your Porterville Home?</h2>
