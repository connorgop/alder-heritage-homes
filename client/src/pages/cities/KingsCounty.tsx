  ...
  return (
    <CityPage
      ...
      faqs={[
        ...
        { q: "Do you buy homes near NAS Lemoore?", a: "Yes. We regularly work with military families receiving PCS orders who need to sell quickly. We understand the urgency and can close in 3 days." },
