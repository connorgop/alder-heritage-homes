...
export default function SellMyHouseClovis() {
  return (
    <ServicePage
      ...
      subtitle="Ready to sell your Clovis home? Get a fair cash offer in 24 hours. Close in 3 days or on your timeline. No repairs, no agent fees, no wholesalers."
      heroImage={HERO_IMG}
      heroImageAlt="Sell my house Clovis CA — Alder Heritage Homes cash buyer"
      metaDescription="Sell my house Clovis CA — Alder Heritage Homes pays cash, closes in 3 days, buys any condition. Licensed CA Agent DRE #02219124. Free Broker Opinion of Value. Call (559) 281-8016."
