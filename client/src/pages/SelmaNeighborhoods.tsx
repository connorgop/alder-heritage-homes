/* ============================================================
   ALDER HERITAGE HOMES — Selma Neighborhoods Hub
   Heritage Warmth design: Terracotta + Slate Green + Oat
   Targets: "sell my house Selma CA neighborhoods"
   ============================================================ */
...
const neighborhoods = [
  { name: "Downtown Selma", slug: "downtown-selma", desc: "Historic Raisin Capital core, older construction, deferred maintenance, estate and probate sellers." },
  { name: "East Selma", slug: "east-selma", desc: "High rental density, mid-century construction, cash buyer activity, tenant complications." },
  { name: "West Selma", slug: "west-selma", desc: "Newer subdivisions, better condition, relocation and divorce sellers." },
  { name: "Floral Avenue Corridor", slug: "floral-avenue", desc: "Main residential artery, mix of owner-occupied and rental properties, older construction." },
];

export default function SelmaNeighborhoods() {
  useSEO({
    title: "Selma Neighborhoods — Sell Fast",
      ...
      <section className="py-16" style={{ background: "linear-gradient(135deg, oklch(0.22 0.01 60) 0%, oklch(0.30 0.04 155) 100%)" }}>
        <div className="container text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-bold uppercase tracking-widest mb-5"
            ...
            <MapPin size={12} /> Selma, CA · Fresno County
          </div>
          <h1 style={{ fontFamily: "'Lora', serif", fontSize: "clamp(1.8rem, 4vw, 2.8rem)", fontWeight: 700, color: "white", lineHeight: 1.2 }}>
            ...
            <span style={{ color: "oklch(0.75 0.12 60)" }}>Selma Neighborhood</span>
          </h1>
      ...
      <section className="py-16">
        <div className="container">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-2 gap-6 mb-12">
            {neighborhoods.map((n) => (
              <Link key={n.slug} href={`/selma-neighborhoods/${n.slug}`}>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <p className="leading-relaxed mb-4" style={{ color: "oklch(0.40 0.01 60)", fontFamily: "'Nunito Sans', sans-serif" }}>
                Selma is a small agricultural city in Fresno County, located along Highway 99 in the heart of California's Raisin Belt. Known as the "Raisin Capital of the World," Selma's economy has long been tied to agriculture — and its housing market reflects that history.
              </p>
              <p className="leading-relaxed mb-4" style={{ color: "oklch(0.40 0.01 60)", fontFamily: "'Nunito Sans', sans-serif" }}>
                Many homes in Selma are older construction (1940s–1980s), with deferred maintenance, outdated systems, and characteristics that make conventional financing difficult. A direct cash sale is often the most practical option for Selma homeowners who need speed and certainty.
              </p>
              <div className="grid grid-cols-3 gap-4 mt-6">
                {[
                  { label: "Median Price", value: "$280K" },
                  { label: "Avg Days on Market", value: "47" },
                  { label: "Cash Buyer Share", value: "40%" },
                ].map((s) => (
              ...
              <div className="mt-6 space-y-2">
                ...
                <Link href="/sell-house-fast-selma-ca" className="block text-sm font-medium hover:underline" style={{ color: "oklch(0.45 0.12 42)", fontFamily: "'Nunito Sans', sans-serif" }}>
                  → Sell House Fast in Selma
                </Link>
            ...
            <div className="rounded-2xl overflow-hidden" style={{ background: "oklch(0.55 0.13 42)" }}>
              <div className="px-6 pt-6 pb-2">
                <h3 className="font-bold text-lg mb-1" style={{ fontFamily: "'Lora', serif", color: "white" }}>Get Your Selma Cash Offer</h3>
