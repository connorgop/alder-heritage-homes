...
export default function VisaliaNeighborhood_CollegeOfTheSequoias() {
  useSEO({
    title: "Sell My House in College of the Sequoias Area, Visalia CA — Cash Buyers | Alder Heritage Homes",
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-8">
            <div>
              ...
              <p className="text-[#5a6e5a] leading-relaxed">The neighborhoods surrounding College of the Sequoias on Mooney Blvd have a high concentration of student rentals, faculty-owned homes, and long-time owner-occupied properties. This creates a unique mix of motivated sellers and consistent buyer demand.</p>
              <p className="text-[#5a6e5a] leading-relaxed mt-3">
                Home values in the College of the Sequoias Area area range from <strong>$250,000–$380,000</strong> in Q1 2026.
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li key="0" className="flex gap-2 items-start"><span className="text-[#c8a96e] mt-1">✓</span><span className="text-[#5a6e5a] text-sm">Student rental properties with deferred maintenance</span></li>
                <li key="1" className="flex gap-2 items-start"><span className="text-[#c8a96e] mt-1">✓</span><span className="text-[#5a6e5a] text-sm">Faculty relocating out of the area</span></li>
                <li key="2" className="flex gap-2 items-start"><span className="text-[#c8a96e] mt-1">✓</span><span className="text-[#5a6e5a] text-sm">Inherited properties from long-time Visalia residents</span></li>
                <li key="3" className="flex gap-2 items-start"><span className="text-[#c8a96e] mt-1">✓</span><span className="text-[#5a6e5a] text-sm">Landlords tired of managing student tenants</span></li>
              </ul>
            </div>
