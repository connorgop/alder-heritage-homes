      ...
      <section className="bg-[#2d4a3e] text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          <nav className="text-sm text-white/60 mb-4">
            ...
            <span className="text-white">Downtown Visalia</span>
          </nav>
          <p className="text-[#c8a96e] text-sm font-bold tracking-widest uppercase mb-2">Visalia, CA</p>
          <h1 className="text-3xl md:text-4xl font-bold mb-3 leading-tight">
            Sell My House in <span className="text-[#c8a96e]">Downtown Visalia</span>
          </h1>
          <p className="text-white/80 text-lg mb-6">Historic Homes in a Revitalized Urban Core — Cash offers in 24 hours, close in 7 days.</p>
      ...
      <section className="py-14 px-4">
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-8">
            <div>
              <h2 className="text-2xl font-bold text-[#1a2e1a] mb-3">About Downtown Visalia</h2>
              <p className="text-[#5a6e5a] leading-relaxed">Downtown Visalia has undergone significant revitalization over the past decade, with historic homes, mixed-use properties, and a growing arts and dining scene. Historic properties come with unique challenges — knob-and-tube wiring, original plumbing, and preservation requirements — that make cash buyers an attractive option.</p>
              <p className="text-[#5a6e5a] leading-relaxed mt-3">
                Home values in the Downtown Visalia area range from <strong>$220,000–$380,000</strong> in Q1 2026.
            ...
            <div>
              <h2 className="text-xl font-bold text-[#1a2e1a] mb-3">Common Situations We Handle in Downtown Visalia</h2>
              <ul className="space-y-2">
                <li key="0" className="flex gap-2 items-start"><span className="text-[#c8a96e] mt-1">✓</span><span className="text-[#5a6e5a] text-sm">Historic homes with expensive renovation requirements</span></li>
                <li key="1" className="flex gap-2 items-start"><span className="text-[#c8a96e] mt-1">✓</span><span className="text-[#5a6e5a] text-sm">Estate sales for long-time downtown residents</span></li>
                <li key="2" className="flex gap-2 items-start"><span className="text-[#c8a96e] mt-1">✓</span><span className="text-[#5a6e5a] text-sm">Mixed-use properties with commercial tenants</span></li>
                <li key="3" className="flex gap-2 items-start"><span className="text-[#c8a96e] mt-1">✓</span><span className="text-[#5a6e5a] text-sm">Deferred maintenance on pre-1950 construction</span></li>
              </ul>
            </div>
          ...
          <div className="space-y-6">
            <CashOfferForm city="Downtown Visalia, Visalia" />
