      ...
      <section className="bg-[#2d4a3e] text-white py-14 px-4">
        <div className="max-w-4xl mx-auto">
          <nav className="text-sm text-white/60 mb-4">
            ...
            <span className="text-white">Mooney Blvd Corridor</span>
          </nav>
          <p className="text-[#c8a96e] text-sm font-bold tracking-widest uppercase mb-2">Visalia, CA</p>
          <h1 className="text-3xl md:text-4xl font-bold mb-3 leading-tight">
            Sell My House in <span className="text-[#c8a96e]">Mooney Blvd Corridor</span>
          </h1>
          <p className="text-white/80 text-lg mb-6">Visalia's Main Residential Spine — Cash offers in 24 hours, close in 7 days.</p>
      ...
      <section className="py-14 px-4">
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-8">
            <div>
              <h2 className="text-2xl font-bold text-[#1a2e1a] mb-3">About Mooney Blvd Corridor</h2>
              <p className="text-[#5a6e5a] leading-relaxed">The Mooney Blvd corridor runs north-south through the heart of Visalia, anchoring one of the city's most active residential markets. Homes here range from 1960s ranch-style to newer 1990s construction, with strong demand from both owner-occupants and investors.</p>
              <p className="text-[#5a6e5a] leading-relaxed mt-3">
                Home values in the Mooney Blvd Corridor area range from <strong>$280,000–$420,000</strong> in Q1 2026.
            ...
            <div>
              <h2 className="text-xl font-bold text-[#1a2e1a] mb-3">Common Situations We Handle in Mooney Blvd Corridor</h2>
              <ul className="space-y-2">
                <li key="0" className="flex gap-2 items-start"><span className="text-[#c8a96e] mt-1">✓</span><span className="text-[#5a6e5a] text-sm">Landlords exiting the rental market</span></li>
                <li key="1" className="flex gap-2 items-start"><span className="text-[#c8a96e] mt-1">✓</span><span className="text-[#5a6e5a] text-sm">Inherited properties</span></li>
                <li key="2" className="flex gap-2 items-start"><span className="text-[#c8a96e] mt-1">✓</span><span className="text-[#5a6e5a] text-sm">Deferred maintenance on 1960s–1980s homes</span></li>
                <li key="3" className="flex gap-2 items-start"><span className="text-[#c8a96e] mt-1">✓</span><span className="text-[#5a6e5a] text-sm">Divorce situations requiring fast sale</span></li>
              </ul>
            </div>
          ...
          <div className="space-y-6">
            <CashOfferForm city="Mooney Blvd Corridor, Visalia" />
