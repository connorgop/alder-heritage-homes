...
export default function VisaliaNeighborhood_MineralKing() {
  useSEO({
    title: "Sell My House in Mineral King Area, Visalia CA — Cash Buyers | Alder Heritage Homes",
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li key="0" className="flex gap-2 items-start"><span className="text-[#c8a96e] mt-1">✓</span><span className="text-[#5a6e5a] text-sm">Aging homeowners downsizing</span></li>
                <li key="1" className="flex gap-2 items-start"><span className="text-[#c8a96e] mt-1">✓</span><span className="text-[#5a6e5a] text-sm">Inherited properties from parents</span></li>
                <li key="2" className="flex gap-2 items-start"><span className="text-[#c8a96e] mt-1">✓</span><span className="text-[#5a6e5a] text-sm">Deferred maintenance on post-war construction</span></li>
                <li key="3" className="flex gap-2 items-start"><span className="text-[#c8a96e] mt-1">✓</span><span className="text-[#5a6e5a] text-sm">Landlords exiting the rental market</span></li>
              </ul>
            </div>
