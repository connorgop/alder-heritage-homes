/* ============================================================
   SELL MY HOUSE MADERA CA — /sell-my-house-madera-ca
   Primary: "sell my house madera" "sell my house madera ca"
   Secondary: "cash home buyers madera" "we buy houses madera"
              "sell house as is madera" "sell my home madera"
              "house buyers madera" "sell house fast madera"
              "sell my house fast madera" "home buyers madera"
   ============================================================ */
import ServicePage from "@/components/ServicePage";

const HERO_IMG = "https://images.unsplash.com/photo-1570129477492-45c003edd2be?w=1400&q=80";

export default function SellMyHouseMadera() {
  return (
    <ServicePage
      slug="/sell-my-house-madera-ca"
      badge="Madera's Trusted Cash Home Buyer"
      title="Sell My House in Madera, CA"
      subtitle="Ready to sell your Madera home? Get a fair cash offer in 24 hours. Close in 5–7 days or on your timeline. No repairs, no agent fees, no wholesalers."
      heroImage={HERO_IMG}
      heroImageAlt="Sell my house Madera CA — Alder Heritage Homes cash buyer"
      metaDescription="Sell my house Madera CA — Alder Heritage Homes pays cash, closes in 5–7 days, buys any condition. Licensed CA Agent DRE #02219124. Free Broker Opinion of Value. Call (559) 281-8016."
      intro="If you're thinking 'I need to sell my house in Madera,' you have more options than you might realize — and more protection than most sellers know to ask for. Alder Heritage Homes is a licensed California real estate agent (DRE #02219124) and a direct cash buyer. We are not a wholesaler. Connor Morris personally buys every home, closes with his own funds, and makes sure every seller understands exactly what their home is worth before they decide anything. Whether you need to sell in 7 days or 90 days, we make the process simple, transparent, and fair."
      sections={[
        {
          heading: "Your Three Options When You Want to Sell Your Madera Home",
          body: (
        ...
        {
          heading: "The Madera Housing Market in 2026 — What Sellers Need to Know",
          body: "Madera's median home price is approximately $290,000–$320,000 in 2026, with move-in ready homes selling in 25–40 days. As the Madera County seat and a growing agricultural hub 20 minutes north of Fresno, Madera has seen steady appreciation driven by UC Merced proximity and Central Valley job growth. However, many Madera homes — particularly multi-generational family properties and older agricultural-area homes — need significant work before they'd qualify for conventional financing. Cash buyers represent a strong share of Madera transactions, especially for properties needing repairs.",
        },
        {
          heading: "Madera Neighborhoods We Buy In",
          body: (
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              {["Millview", "Madera Ranchos", "Gateway District", "Valley Vista", "Sierra Vista", "Downtown Madera", "Westside Madera", "Madera Acres", "Bonadelle Ranchos"].map((n) => (
        ...
        {
          heading: "Situations We Help Madera Sellers With",
          body: (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {[
                ...
                { label: "Multi-generational family home", href: "/sell-parents-house-fresno" },
        ...
        },
        {
          ...
          body: (
            <div className="space-y-4">
              {[
                { step: "1", title: "Submit Your Address", body: "Call (559) 281-8016 or enter your address in the form. We research your Madera property within 24 hours." },
      ...
      faq={[
        {
          q: "How do I sell my house fast in Madera?",
        ...
        {
          q: "What is my Madera house worth?",
          a: "We provide a free third-party Broker Opinion of Value with every offer — an independent assessment that tells you what your home would sell for on the open market. Madera median home prices are approximately $290,000–$320,000 in 2026, but value varies significantly by neighborhood, condition, and proximity to Fresno.",
        },
        {
          q: "Do I have to make repairs before selling my Madera home?",
        ...
        {
          q: "How long does it take to sell my house in Madera?",
          a: "With Alder Heritage Homes, you can close in as few as 5 business days. The timeline is yours — if you need 45 or 90 days to arrange your move, we accommodate that too. Traditional listings in Madera average 60–90 days from listing to close.",
        },
        {
          q: "Do you buy homes in Madera Ranchos and Bonadelle Ranchos?",
          a: "Yes — we buy throughout all of Madera County including Madera Ranchos, Bonadelle Ranchos, Gateway District, Millview, Valley Vista, and all surrounding communities. We also serve Chowchilla, Oakhurst, and the broader Madera County area.",
        },
        {
          q: "Can I sell my house if I'm behind on mortgage payments in Madera?",
        ...
        {
          q: "What if my Madera home needs a lot of work?",
          a: "That's exactly the situation we specialize in. We buy homes that need full renovations, have deferred maintenance, or wouldn't qualify for conventional financing. We price the property based on its current condition and provide a transparent written offer with our valuation methodology.",
        },
      ]}
      ctaTitle="Ready to Sell Your Madera Home?"
      ...
      relatedLinks={[
        ...
        { label: "Sell Hoarder House", href: "/sell-hoarder-house" },
