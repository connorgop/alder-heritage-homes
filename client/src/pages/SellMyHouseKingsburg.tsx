...
export default function SellMyHouseKingsburg() {
  return (
    <ServicePage
      ...
      subtitle="Ready to sell your Kingsburg home? Get a fair cash offer in 24 hours. Close in 5–7 days or on your timeline. No repairs, no agent fees, no wholesalers."
      heroImage={HERO_IMG}
      heroImageAlt="Sell my house Kingsburg CA — Alder Heritage Homes cash buyer"
      metaDescription="Sell my house Kingsburg CA — Alder Heritage Homes pays cash, closes in 5–7 days, buys any condition. Licensed CA Agent DRE #02219124. Free Broker Opinion of Value. Call (559) 281-8016."
