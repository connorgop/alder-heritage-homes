...
const articleChunk1: Record<string, React.ReactNode> = {
  ...
  "how-fast-can-i-sell-my-house-fresno": (
    <div className="prose-heritage">
      ...
      <ul>
        ...
        <li>Title search takes 3 days</li>
        <li>Closing documents prepared in 1–2 days</li>
      </ul>
      <p>Our minimum closing time is 3 days. Most of our sales close in 10–21 days.</p>
  ...
  "sell-hoarder-house-fresno-no-cleanout": (
    <div className="prose-heritage">
      ...
      <ol>
        ...
        <li><strong>You choose your closing date.</strong> We can close in as little as 3 days, or we can give you more time if you need it.</li>
  ...
  "dont-get-wholesaled-fresno-cash-buyer-warning": (
    <div className="prose-heritage">
      ...
      <p>This article is written by Connor Morris, a licensed California real estate agent (DRE #02219124) who actually buys homes with his own capital. I know the Fresno market. I know the players. And I'm going to tell you exactly how to tell who is real and who isn't.</p>
  ...
  "sell-house-merced-modesto-stockton-cash": (
    <div>
      ...
      <p>We buy homes in Merced, Modesto, Stockton, and Turlock. We are based in Fresno and licensed in California (DRE #02219124). We are not wholesalers. When we make an offer, we are the buyer. We include a free third-party broker opinion of value with every offer. We close in 3 days or on your timeline.</p>
  ...
  "sell-fire-damaged-house-fresno": (
    <div className="prose-heritage">
      ...
      <p>This is often the fastest path — we can close in 3 days. It typically results in a lower net than a full insurance payout and rebuild, but it eliminates months of uncertainty, contractor management, and insurance disputes. For homeowners who are emotionally done with the property, or who cannot afford to carry the costs during a lengthy rebuild, it is often the right choice.</p>
  ...
  "sell-house-bad-tenants-fresno": (
    <div className="prose-heritage">
      ...
      <p>We purchase rental properties in Fresno with tenants in place — including problem tenants. Our process is straightforward. We assess the property's value based on comparable sales and the cost of the eviction process. We make you a cash offer that reflects the current situation. We close on your timeline — typically 3 days. After closing, we handle the tenant situation ourselves.</p>
  ...
  "downsize-sell-home-fast-fresno": (
    <div className="prose-heritage">
      ...
      <p>Call us at (559) 281-8016. We can close on your current home in 3 days, on your timeline, with a rent-back if you need it.</p>
    </div>
  ),
  ...
  "sell-house-too-much-stuff-fresno": (
    <div className="prose-heritage">
      ...
      <p>This option is particularly well-suited for seniors moving to a retirement community or assisted living, where space is limited and you can only bring a fraction of what you own anyway. Take your favorites. Leave the rest. Close in 3 days.</p>
  ...
  "power-of-attorney-sell-house-california": (
    <div className="prose-heritage">
      ...
      <p>Once you have confirmed that your POA grants real estate authority and is properly recorded, you can sell the home just as the principal would. We work with agents under POA regularly and understand the documentation requirements. We can close in 3 days once the paperwork is in order.</p>
